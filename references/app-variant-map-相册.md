...
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
| 导航栏 | BottomBar_Showcase_Fab_01 | BottomBar_Showcase_Fab_02 | BottomBar_Showcase_Fab_01 | BottomBar_Showcase_Fab_02 | | | BottomBar_Showcase_Fab_01 | | | BottomBar_Showcase_Fab_02 | | | Sidebar_Component_PAD_NLC_01 | | TopBar_01 | | | Sidebar_Component_PAD_NLC_01 | | TopBar_01 |
| 标题栏 | NavigationBar_ComponentSet_01 | 无标题栏 | NavigationBar_ComponentSet_04 | NavigationBar_ComponentSet_04 | | | NavigationBar_ComponentSet_04 | | | NavigationBar_ComponentSet_04 | | | N栏：NavigationBar_ComponentSet_12；C栏：NavigationBar_ComponentSet_10 | | TopBar_01 标题栏 | | | N栏：NavigationBar_ComponentSet_12；C栏：NavigationBar_ComponentSet_10 | | TopBar_01 标题栏 |
| 搜索 | Fab_01；白色 | Fab_01；白色 | Fab_01；白色 | Fab_01；白色 | | | Fab_01；白色 | | | Fab_01；白色 | | | C栏：NavigationBar_ComponentSet_07 搜索图标 | | TopBar_01 搜索图标 | | | C栏：NavigationBar_ComponentSet_07 搜索图标 | | TopBar_01 搜索图标 |
...
| 导航栏 | BottomBar_Showcase_Fab_02 | 左24；右24 |
...
| 搜索 | Fab_01 | 右24 |
| 搜索 | NavigationBar_ComponentSet_07 | 左12；右12 |
...
| NLC | 不存在 | 不存在 | 不存在 |
| NLC 收起 | 不存在 | 不存在 | 不存在 |
| NC | 背景色/surface | 不存在 | 背景色/surface_low |
| LC | 不存在 | 不存在 | 不存在 |
| C | 不存在 | 不存在 | 背景色/surface_low |
