...
- `List_Notes_07` ~ `List_Notes_20`（CSV2 2026-05-21 更新，卡片列表 Fold/Pad 设备分化变体 + 编辑态；待 Figma 探查）
...
| `List_Notes_08` | 待补 | 待补 | 卡片列表 - Fold 外屏 - 编辑 | 待补 | `csv2-listed` |
| `List_Notes_09` | 待补 | 待补 | 卡片列表 - Fold 内屏 竖屏 | 待补 | `csv2-listed` |
| `List_Notes_10` | 待补 | 待补 | 卡片列表 - Fold 内屏 竖屏 - 编辑 | 待补 | `csv2-listed` |
| `List_Notes_11` | 待补 | 待补 | 卡片列表 - Fold 内屏 横屏 | 待补 | `csv2-listed` |
| `List_Notes_12` | 待补 | 待补 | 卡片列表 - Fold 内屏 横屏 - 编辑 | 待补 | `csv2-listed` |
| `List_Notes_13` | 待补 | 待补 | 卡片列表 - Pad 竖屏 | 待补 | `csv2-listed` |
| `List_Notes_14` | 待补 | 待补 | 卡片列表 - Pad 竖屏 - 编辑 | 待补 | `csv2-listed` |
| `List_Notes_15` | 待补 | 待补 | 卡片列表 - Pad 竖屏 收起 | 待补 | `csv2-listed` |
| `List_Notes_16` | 待补 | 待补 | 卡片列表 - Pad 竖屏 收起 - 编辑 | 待补 | `csv2-listed` |
| `List_Notes_17` | 待补 | 待补 | 卡片列表 - Pad 横屏 | 待补 | `csv2-listed` |
| `List_Notes_18` | 待补 | 待补 | 卡片列表 - Pad 横屏 - 编辑 | 待补 | `csv2-listed` |
| `List_Notes_19` | 待补 | 待补 | 卡片列表 - Pad 横屏 收起 | 待补 | `csv2-listed` |
| `List_Notes_20` | 待补 | 待补 | 卡片列表 - Pad 横屏 收起 - 编辑 | 待补 | `csv2-listed` |
...
| `List_Notes_07` ~ `List_Notes_20` | 左 12，右 12 |
